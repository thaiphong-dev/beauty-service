...
const SecondLine = () => {
  return (
    <motion.div className="flex justify-between items-end">
      <div className="text-gray-500 text-[13px] relative top-[50px]">2020</div>

      <motion.div
        className={`${bodoni_Moda.className} text-[200px] relative h-[210px] text-main_text`}
      ...
      >
        <span className="inline-block relative top-[-60px]">&</span>Eyelash
      </motion.div>
